...
setup(
    ...
    entry_points={
        "console_scripts": [
            "translate-gpqa=examples.translate_gpqa:main",
            "translate-aime=examples.translate_aime:main",
            "hunyuan-demo=examples.simple_translation_demo:main",
        ],
    },
)